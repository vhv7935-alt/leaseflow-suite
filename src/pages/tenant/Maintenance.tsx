  ...
  const maintenanceRequests = [
    {
      ...
      updates: [
        {
          date: "2024-01-15",
          message: "Maintenance request reviewed and approved",
          type: "status",
        },
        {
          date: "2024-01-16",
    ...
    },
    {
      ...
      description:
        "Heating system not reaching set temperature, cold air coming out instead of warm.",
      category: "HVAC",
      priority: "High",
      status: "Scheduled",
      ...
      updates: [
        {
          date: "2024-01-11",
          message: "Emergency HVAC service scheduled",
          type: "status",
        },
        {
          date: "2024-01-15",
          message: "Technician will arrive between 9-11 AM",
          type: "info",
        },
      ],
    },
    {
      ...
      description:
        "Main ceiling light in bathroom has burned out and needs replacement.",
      category: "Electrical",
      priority: "Low",
      status: "Completed",
      ...
      updates: [
        {
          date: "2024-01-06",
          message: "Light bulb replaced successfully",
          type: "completion",
        },
        {
          date: "2024-01-06",
